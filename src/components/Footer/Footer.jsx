...
import logo from "../../media/images/res-logo.png";
      ...
      <Container>
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            ...
            <ListGroup className="deliver__time-list">
              <ListGroupItem className=" delivery__time-item border-0 ps-0">
                <p>Location: Cairo, Nacr City, Egypt</p>
              </ListGroupItem>
              <ListGroupItem className=" delivery__time-item border-0 ps-0">
                <span>Phone: 01060074246</span>
              </ListGroupItem>

              <ListGroupItem className=" delivery__time-item border-0 ps-0">
                <span>Email: belalaboseada@gmail.com</span>
              </ListGroupItem>
            </ListGroup>
          </Col>
        ...
        <Row className="mt-5">
          ...
          <Col lg="6" md="6">
            <div className="social__links d-flex align-items-center gap-4 justify-content-end">
              ...
              <span>
                <Link to="www.linkedin.com/in/belal-hesham">
