...
//                 const value = JSON.parse(localStorage.getItem("FavItems"));
...
//                 }
//                 state.FavItems.splice(index, 1, newValue);
...
//                 state.cartItems = state.FavItems.filter((item) => item.id !== id);
//             } else {
//                 existingItem.quantity--;
